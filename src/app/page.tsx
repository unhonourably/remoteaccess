...
export const metadata: Metadata = {
  title: 'Parkway Help Center | Student Support & Resources',
  description: 'A safe space for Parkway students to find support with cyberbullying, mental health, and other challenges.',
}
      ...
      <header className="relative px-4 md:px-8 pt-24 pb-32 md:pt-32 md:pb-40 bg-white overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto">
          <div className="text-center space-y-8">
            ...
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-slide-up opacity-0 [animation-delay:800ms] [animation-fill-mode:forwards]">
              <Link
                href="/get-help"
              ...
              <Link
                href="/resources"
                className="px-8 py-4 bg-white rounded-full font-medium text-gray-700 border border-gray-200 transition-all duration-300 hover:border-red-200 hover:bg-red-50"
              >
                View Resources
              </Link>
            </div>
